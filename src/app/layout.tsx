            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
                ...
                <div className="col-span-2 sm:col-span-1">
                  <div className="flex items-center gap-2 font-bold text-lg tracking-tight mb-3">
                    <span className="w-7 h-7 flex items-center justify-center shrink-0">
                      <svg width="22" height="24" viewBox="0 0 40 44" fill="none" className="text-gray-900"><path d="M5 5 L33 2 L36 30 L8 33 Z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" fill="none"/><line x1="19" y1="3.5" x2="22" y2="31.5" stroke="currentColor" strokeWidth="2"/><line x1="6.5" y1="19" x2="34.5" y2="16" stroke="currentColor" strokeWidth="2"/><path d="M19 11 L15 11.2 L15 14.2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square" fill="none"/><path d="M28 16.5 L28 13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square" fill="none"/><path d="M12 19.8 L12 23" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square" fill="none"/><path d="M22 24 L26 23.8 L26 21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square" fill="none"/><path d="M8 33 L36 30 L35 37 L7 40 Z" fill="currentColor"/><path d="M5 5 L8 33 L7 40 L4 12 Z" fill="currentColor"/></svg>
                    </span>
                    Tenuq
                  </div>
              ...
              <div className="border-t border-gray-200/60 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-xs text-gray-400">
                  &copy; {new Date().getFullYear()} Tenuq Ltd. All rights reserved.
                </p>
